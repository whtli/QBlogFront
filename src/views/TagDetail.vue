  ...
  <div>
    ...
    <div style="margin-top: 5%" align="center">
      <div class="ui top segment" style="text-align: center; width: 96%">
        <h2 class="m-text-500">标签“ {{ tagName }} ”中的博客</h2>
        <p>共 {{ total }} 篇</p>
      </div>
      <div align="center">
...
<script>
  import { getBlogByTagId } from '@/api/blog'
  ...
  export default {
    ...
    created() {
      ...
      if (this.$route.params.id) {
        ...
        this.getBlogByTagId(this.$route.params.id)
      }
    },
    methods: {
      ...
      // 根据分类id查询博客列表
      getBlogByTagId(tagId) {
        getBlogByTagId(tagId).then(res => {
          if (res.code === 200) {
